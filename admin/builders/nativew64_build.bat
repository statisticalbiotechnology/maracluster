...
%CMAKE_EXE% -G "Visual Studio %MSVC_VER%" -A x64 -DBOOST_ROOT="%PWIZ_DIR%\libraries\%BOOST_BASE%" -DZLIB_INCLUDE_DIR="%PWIZ_DIR%\libraries\%ZLIB_BASE%" -DCMAKE_PREFIX_PATH="%PWIZ_DIR%" "%SRC_DIR%\maracluster"
...
if "%VENDOR%" == "true" (
  ...
  %CMAKE_EXE% -G "Visual Studio %MSVC_VER%" -A x64 -DBOOST_ROOT="%PWIZ_DIR%\libraries\%BOOST_BASE%" -DZLIB_INCLUDE_DIR="%PWIZ_DIR%\libraries\%ZLIB_BASE%" -DCMAKE_PREFIX_PATH="%PWIZ_DIR%" -DVENDOR_SUPPORT=ON "%SRC_DIR%\maracluster"
...
if not "%NO_GUI%" == "true" (
  ...
  %CMAKE_EXE% -G "Visual Studio %MSVC_VER%" -A x64 -DBOOST_ROOT="%PWIZ_DIR%\libraries\%BOOST_BASE%" -DZLIB_INCLUDE_DIR="%PWIZ_DIR%\libraries\%ZLIB_BASE%" -DCMAKE_PREFIX_PATH="%PWIZ_DIR%;%INSTALL_DIR%\Qt-dynamic" -DVENDOR_SUPPORT=OFF "%SRC_DIR%\maracluster\src\qt-gui"
...
if "%VENDOR%" == "true" (
  call :copytorelease "%BUILD_DIR%\maracluster-vendor-support\mar*.exe"
)
